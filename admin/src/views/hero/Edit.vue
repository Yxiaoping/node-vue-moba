    ...
    <el-form label-width="120px" @submit.native.prevent="save">
      ...
      <el-form-item label="顺风出装">
        <el-select v-model="model.items1" multiple>
          <el-option v-for="item in items" :label='item.name'
          :value='item._id' :key="item._id"></el-option>
        </el-select>
      </el-form-item>
        ...
        >
          ...
          <i v-else class="el-icon-plus avatar-uploader-icon"></i>
            ...
            <el-form-item label='描述'>
              <el-input v-model="item.decription" type='textarea'></el-input>
            </el-form-item>
      ...
      <el-tab-pane label='最佳搭档' name='partners'>
        <el-button size='small' @click="model.partners.push({})"><i class="el-icon-plus"></i> 添加技能</el-button>
        <el-row type='flex' style='flex-wrap:wrap'>
          <!-- el-col是循环的，数据多一条，el-col就多一个 -->
          <el-col :md='12' v-for="(item,i) in model.partners" :key='i'>
            <el-form-item label='英雄'>
              <el-select v-model="item.hero" fliterable>
                <el-option 
